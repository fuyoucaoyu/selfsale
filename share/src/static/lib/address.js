...
function Dsy(){
	this.items = {};
	this.level = '';
	// this.levels = ['province', 'city', 'county'];
...
Dsy.prototype.getCurLevel = function () {
	return this.items[this.level];
}

Dsy.prototype.getNextLevel = function (id) {
	this.level += '_' + id;
	if (!this.exists(this.level)) {
		return [];
	}
	return this.items[this.level];
}

Dsy.prototype.getProvince = function(){
	this.level = '0';
	return this.items['0'];
}

Dsy.prototype.getCityByProvince = function(pId){
	var id = '0_' + pId;
	this.level = id;
	if (!this.exists(id)) {
		return [];
...
Dsy.prototype.getCountyByCity = function(pId, cId){
